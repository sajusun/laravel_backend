...
<body>
	...
	<!--================ Start Header Area =================-->
	@include('includable/header-link');
	<!--================ End Header Area =================-->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Sakhawat Hossain</h1>
							<h5 class="text-uppercase">junior app developer</h5>
	...
	<section class="about_area section_gap">
		<div class="container">
			<div class="row justify-content-start align-items-center">
				<div class="col-lg-5">
					<div class="about_img">
						<img class="" src="img/about-us.png" alt="about image">
					</div>
				</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">customLab</a>
